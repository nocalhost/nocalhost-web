    ...
    resources: {
        ...
        space: {
            ...
            fields: {
                ...
                reset: 'Reset',
                requestTotalMem: 'Request Total Memory',
                requestTotalCPU: 'Request Total CPU',
                limitTotalMem: 'Limit Total Memory',
                limitTotalCPU: 'Limit Total CPU',
                PVC_num: 'Number of PVC',
                storageCapacity: 'Storage Capacity',
                lbNum: 'Number of LoadBalancer',
                requestMem: 'Request Memory',
                requestCPU: 'Request CPU',
                limitMem: 'Limit Memory',
                limitCPU: 'limit CPU',
            },
